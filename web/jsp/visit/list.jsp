									...
									<TD><SPAN id=pagelink>
											<DIV
                                                ...
                                                <c:if test="${pageBean.currentPage != 1}">
													[<A href="${pageContext.request.contextPath}/visit_list.action?currentPage=${pageBean.currentPage - 1}">前一页</A>]
												</c:if>
                                                <%-- 如果最后一页，没有下一页 --%>
                                                <c:if test="${pageBean.currentPage != pageBean.totalPage}">
													[<A href="${pageContext.request.contextPath}/visit_list.action?currentPage=${pageBean.currentPage + 1}">后一页</A>]
												</c:if>
